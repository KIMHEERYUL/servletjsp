...
<div class="card m-2">
	...
	<div class="card-body">
	<h4>GET 방식</h4>
		<a href="${pageContext.request.contextPath}/exam02/GetController?param=1=value1&param2=value2" class="btn btn-info">링크로 이동</a>
		<form method="get" action="${pageContext.request.contextPath}/exam02/GetController">
			...
			<input type="submit" value="Form으로 제출" class="btn btn-info"/><br/>
		</form>
		<hr/>
